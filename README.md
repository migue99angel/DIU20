...
-----|-----
**Preguntas**  Hay un fallo a la hora de mostrar el mapa de ubicación. ¿Se podría mejorar?<br/> ¿Se podrían añadir más opciones para filtrar viajes?<br/> Estaría bien tener una opción adicional para hacer amigos en la plataforma y poder hacer viajes conjuntos.|**Nuevas ideas**  Mostrar ejemplos de viajes que estén activos actualmente, de diferentes categorías.<br/> Intentar que cuando un usuario se registre, este consiga publicar un viaje o se inscriba en uno existente en las primeras visitas del usuario.<br/> La plataforma no cuenta con redes sociales de ningún tipo. No se puede contactar con ellos más allá del correo. 
