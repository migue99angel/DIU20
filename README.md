...
**Interesante**  Diseño limpio. Se destaca lo importante y utiliza una paleta de colores agradable a la vista. Interfaz amigable. La información está concentrada y se destaca lo importante. El panel de control de usuario destaca las opciones importantes y es claro. |**Críticas**  Añadir un sistema de mensajes para poder establecer contacto de manera más fácil con compañeros de viaje. Permitir la búsqueda de viajes por varios aspectos. Permitir añadir en la descripción el número de integrantes que se buscan y los integrantes que buscan compañeros.
-----|-----
